...
@Repository
@Qualifier("EmployeeDaoImpl_HibernateNative")
public class EmployeeDaoImpl_HibernateNative implements EmployeeDao {


    EntityManager entityManager;

    @Autowired
    public EmployeeDaoImpl_HibernateNative(EntityManager entityManager) {
