...
@Repository(value = "EmployeeDaoImpl_JPA_DATA")
//@Qualifier("EmployeeDaoImpl_JPA_ABC")
public class EmployeeDaoImpl_JPAData implements EmployeeDao {
    EntityManager entityManager;

    @Autowired
    public EmployeeDaoImpl_JPAData(EntityManager entityManager) {
